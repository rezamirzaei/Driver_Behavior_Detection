...
@celery_app.task(name="src.api.celery_tasks.run_custom_learning_task")
def run_custom_learning_task(payload: Dict[str, Any]) -> Dict[str, Any]:
    """Execute one custom-learning request in Celery worker process."""
